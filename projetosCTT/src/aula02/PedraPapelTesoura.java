...
/*
 * Faça a implementação do Jogo Pedra, Papel e Tesoura (Jokempô). O algoritmo deverá perguntar 
 * qual é a escolha do jogador 1 (Pedra [pe], Papel [pa], Tesoura [t]) e deverá fazer o mesmo 
 * para o jogador 2. No final da execução o algoritmo deverá dizer qual é o jogador vencedor 
 * ou se houve empate.
 */
